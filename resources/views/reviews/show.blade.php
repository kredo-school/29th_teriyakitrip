            ...
            <div class="col-12 col-md-4">
                <div class="row">
                    <div class="d-flex flex-column flex-md-row align-items-center justify-content-md-end">
                        ...
                        <button class="btn btn-outline-warning ms-md-3"><i class="fa-solid fa-star"></i></button>
                    </div>
                </div>
                <!-- レビュー作成ボタン -->
                <div class="row">
    ...
    <div class="restaurant-details mt-4">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <h3>Price</h3>
                <p>{!! isset($restaurant['price_level']) ? str_repeat('<i class="fa-solid fa-yen-sign fs-3 text-muted me-1"></i>', $restaurant['price_level']) : 'Price not available' !!}</p>
            </div>
