        ...
        <div id="mypageContent" class="mt-4">
            ...
            <!-- Itinerary Section -->
                ...
                <div class="row">
                    ...
                    <h2 class="text-center mb-4" style="color: #E97911; font-weight: bold;">Restaurant's Review</h2>
                    <div class="row">
                    ...
                    @include('mypage.restaurant_reviews') {{-- 👈 restaurant_reviews.blade.php を呼び出す --}}
