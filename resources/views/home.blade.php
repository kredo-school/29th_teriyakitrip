    ...
    <div class="region-list-width container-md"> <!-- REGION LIST SECTION -->
        <div class="text-center">
            <div class="h3 mt-3 d-flex flex-wrap justify-content-center text-lg font-semibold fw-bold">
                <a href="{{ route('regions.overview', ['prefecture_id' => 1]) }}" class="mx-2 region-1 region-clickable">Hokkaido</a>
                ...
                <a href="{{ route('regions.overview', ['prefecture_id' => 47]) }}" class="mx-2 region-10 region-clickable">Okinawa</a>
            </div>
        </div>
    </div>
            ...
            @foreach ($popularRestaurants as $restaurant)
                <div class="col-4">
                    <div class="card shadow-sm border-0 w-100 rounded-4">
                        <img src="{{ $restaurant->photo }}" alt="{{ $restaurant->name }}" class="rounded-top-4 img-fluid" style="height: 200px; object-fit: cover;">
                        <div class="card-body p-2">
