                    ...
                    <div class="restaurant-item container">
                        <div class="row align-items-center">
                            ...
                            <div class="col-12 col-md-3 d-flex flex-column flex-md-row justify-content-end mt-2 mt-md-0">
                                <a href="/restaurants/${restaurant.place_id}" id="viewReviewButton" class="btn btn-sm w-100 w-md-auto mb-2 mb-md-0 me-md-2">View Details</a>
                                <a href="/restaurants/${restaurant.place_id}/review" id="createReviewButton" class="btn btn-sm w-100 w-md-auto">Create Review</a>
                            </div>
                        </div>
                    </div>
                `;
